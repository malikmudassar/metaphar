                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-options dropdown-menu-right">
                            ...
                            <li>
                                <button class="btn btn-sm btn-block btn-primary" id="options-header-top">Fixed
                                    Side/Header (Top)</button>
                                <button class="btn btn-sm btn-block btn-primary" id="options-header-bottom">Fixed
                                    Side/Header (Bottom)</button>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?=base_url()?>/img/placeholders/avatars/avatar2.jpg" alt="avatar" /> <i
                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <li>
                                ...
                                <a href="./page_ready_pricing_tables.php.html"><i
